...
echo "<script>window.location.href = 'agregar-cliente.php'</script>"; 
 } else {
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 style="color: purple;"class="title1">Agregar Cliente</h3>
							...
							<form method="post">
                               ...
                               <p style="padding-top: 20px; font-size: 15px"> <strong>Género:</strong> 
							 	...
							 	<div class="form-group"> 
								  ...
								  <textarea type="text" class="form-control" id="details" name="details" placeholder="Detalle" required="true" rows="7" cols="4"></textarea> 
								</div>
							  <center>
							    <button type="submit" name="submit" class="btn btn-primary">Agregar Cliente</button> </form> 
							  </center>
						</div>
						<br><br>
					</div>
