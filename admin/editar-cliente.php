	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 style="color: purple;"class="title1">Editar Información de Cliente</h3>
					<div > 
						...
						<div class="form-body">
							<form method="post">
								...
								<div class="form-group"> 
								    <label for="exampleInputPassword1">Género</label> <?php if($row['Gender']=="Male")
								...
								<div class="form-group"> 
									...
									<textarea type="text" class="form-control" id="details" name="details" placeholder="Details" required="true" rows="7" cols="4"><?php  echo $row['Details'];?></textarea> 
								</div>
								<div class="form-group"> 
							    ...
							    <?php } ?>
								<center>
							  <button type="submit" name="submit" class="btn btn-primary">Actualizar Información Cliente</button> 
							   </center>
						    </form> 
						</div>
