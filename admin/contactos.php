	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 style="color: purple;"class="title1">Actualizar Página de Contacto</h3>
					<div  data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<div class="form-group"> 
								<label for="exampleInputEmail1">Sincronización</label> 
							...
							<div class="form-group"> 
							 ...
							 <?php } ?>
							 <center>
							  <button type="submit" name="submit" class="btn btn-primary">Actualizar</button> </form> 
						    </center>
							  </div>
						<br><br>
					</div>
