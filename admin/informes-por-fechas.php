...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 style="color: purple;"class="title1">Reporte entre Fechas</h3>
					...
					<?php
						...
						<h4 align="center" style="color:blue">Reporte desde <?php echo $fdate?> hasta <?php echo $tdate?>Reporte entre Fechas:</h4>
						    ...
						    <tbody>
								...
								<tr> 
									...
									<td><?php  echo $row['PostingDate'];?></td> 
										<td><a href="detalle-factura.php?invoiceid=<?php  echo $row['BillingId'];?>">Detalle Factura</a></td> 
