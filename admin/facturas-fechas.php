	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 style="color: purple;"class="title1">Facturas por Fecha</h3>
					<div> 
					
						<div class="form-body">
							<form method="post" name="bwdatesreport"  action="informes-por-fechas.php" enctype="multipart/form-data">
