...
<html lang="en">
  ...
  <body>
     ...
     <section class="hero-wrap hero-wrap-2" style="background-image: url('images/contactos.jpg'); height:50%" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          ...
          <span  ><img style="width: 35%; height:35%" src="images/logoprincipal.jpg" alt=""></span>
            <h2 style="color: purple;" class="mb-0 bread">Contactos</h2>
